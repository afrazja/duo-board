...
$manifest=@{version='0.1.0';file='DuoBoardHelperSetup.exe';sha256=$hash;size=(Get-Item -LiteralPath $installer).Length;built_at=[DateTime]::UtcNow.ToString('o')}|ConvertTo-Json
