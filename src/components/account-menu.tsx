...
export function AccountMenu() {
  ...
  return <ControlPopover label="Account" above panelClass="!w-[min(360px,calc(100vw-32px))]" buttonClass="!h-11 !w-11 !rounded-full !border-indigo-400/50 !bg-indigo-500/15 !p-0 !font-semibold !text-indigo-100" trigger={initial}>
    ...
    <div className="grid grid-cols-2 gap-2">
      <button type="button" aria-expanded={settingsOpen} onClick={() => setSettingsOpen((open) => !open)} className="min-h-10 rounded-lg border border-zinc-700 text-sm font-medium text-zinc-200 hover:border-zinc-500 hover:bg-zinc-800">Settings</button>
